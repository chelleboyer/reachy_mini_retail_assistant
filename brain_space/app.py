"""Second Brain - Demo Space

A demo Gradio interface showing how the Second Brain
...
def create_app():
    ...
    with gr.Blocks(title="Second Brain Demo", theme=gr.themes.Soft()) as demo:
        gr.Markdown("""
        # 🧠 Second Brain - Demo
        
        **Demo interface for the Second Brain's classification and knowledge management system.**
